import { Box, Button, Flex, Link, Table, TableCaption, TableContainer, Tbody, Td, Text, Tfoot, Th, Thead, Tr } from "@chakra-ui/react";
...
export default function teacher (){
    return(
        ...
        >
            ...
            <Link ml="16px" fontWeight="medium" fontSize="md" mr={5}>Materi</Link>
            <Link ml="16px" fontWeight="medium" fontSize="md" mr={5}>Perubahan Materi</Link>
            </Flex>
            <Flex justifyContent="flex-start" alignItems="center">
                <Button 
                width={'auto'}
